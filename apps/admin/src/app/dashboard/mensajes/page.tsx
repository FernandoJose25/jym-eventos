    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, height: 'calc(100vh - 120px)' }}>
      ...
      <div style={{ display: 'flex', gap: 16, flex: 1, minHeight: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
                      ...
                      <p style={{
                        fontWeight: 600, fontSize: '0.83rem', color: '#0a1628', margin: 0,
        ...
        <div className={selected ? 'msg-detail msg-detail-active' : 'msg-detail'}
          style={{
            flex: 1, background: '#fff', borderRadius: 20, border: '1px solid #e2e8f0',
            ...
            <>
              <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <select value={selected.estado}
                  ...
                  style={{
                    border: '1px solid #e2e8f0', borderRadius: 10, padding: '0.4rem 0.75rem',
              ...
              <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid #f1f5f9', display: 'flex', gap: 10 }}>
                ...
                <a href={`mailto:${selected.correo}?subject=Tu%20consulta%20en%20J%26M%20Decoraciones%20y%20Eventos`}
                  style={{
