...
import {
  DEFAULT_BRANDS, DEFAULT_WHY_ITEMS, DEFAULT_FAQ_ITEMS, DEFAULT_SEO,
  DEFAULT_HERO, DEFAULT_STATS, DEFAULT_ABOUT, DEFAULT_NAVBAR, DEFAULT_FOOTER,
  DEFAULT_CONTACTO, DEFAULT_WHATSAPP, DEFAULT_NOSOTROS, DEFAULT_ANUNCIA, DEFAULT_LEGAL,
