    ...
    <section id="contacto" style={{
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4.5rem' }}>
          ...
          <h2 style={{
            fontFamily: 'var(--font-playfair)', fontSize: 'clamp(2.25rem,4.5vw,3.75rem)',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.55fr', gap: '3rem', alignItems: 'start', maxWidth: 1200, margin: '0 auto' }}
          ...
          <div style={{
            ...
            {/* Card header strip */}
            <div style={{
              padding: '1.75rem 2rem', borderBottom: '1px solid rgba(255,255,255,0.06)',
              background: 'rgba(212,160,23,0.05)',
              display: 'flex', alignItems: 'center', justifyContent: 'space-between'
            }}>
              <div>
                <p style={{
                  fontFamily: 'var(--font-playfair)', color: '#fff', fontSize: '1.1rem',
              ...
              {status === 'success' ? (
                <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
                  ...
                  <a href={`https://wa.me/${wa}?text=Hola%2C%20acabo%20de%20enviar%20mi%20consulta!`}
                    target="_blank" rel="noopener noreferrer"
                    style={{
                      display: 'inline-flex', alignItems: 'center', gap: 8, padding: '0.8rem 1.75rem',
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }} noValidate>
                  ...
                  <div className="cs-form-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    ...
                    <div>
                      <label style={lbl} htmlFor="presupuesto">Presupuesto</label>
                    ...
                    <div style={{ gridColumn: 'span 2' }}>
                      <label style={lbl} htmlFor="mensaje">Mensaje</label>
                  ...
                  {errMsg && (
                    <div style={{
                      background: 'rgba(159,18,57,0.15)', border: '1px solid rgba(252,165,165,0.3)',
                  ...
                  <button type="submit" disabled={status === 'loading'}
                    style={{
                      padding: '1rem', border: 'none', borderRadius: 12,
                    ...
                    {status === 'loading'
                      ? <><span style={{
                        width: 16, height: 16, border: '2px solid rgba(10,22,40,.3)',
                        borderTopColor: '#0a1628', borderRadius: '50%',
                        animation: 'csSpin .7s linear infinite', display: 'inline-block'
                      }} /> Enviando…</>
                      : '✨ Enviar cotización'}
                  </button>
                </form>
