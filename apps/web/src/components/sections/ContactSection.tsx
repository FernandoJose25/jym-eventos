        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1.55fr', gap:'3rem', alignItems:'start' }}
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
            ...
            <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginTop:4 }}>
              {[
                { label:'IG', bg:'linear-gradient(135deg,#833ab4,#fd1d1d,#fcb045)', href: data?.instagram||'https://www.instagram.com/jmdecoracionesyeventos1/' },
                { label:'FB', bg:'#1877f2', href: data?.facebook||'https://www.facebook.com/JM.EventosyDecoraciones' },
                { label:'TT', bg:'#000',    href: data?.tiktok||'https://www.tiktok.com/@jmdecoraciones.18' },
              ].map(({ label, bg, href }) => (
