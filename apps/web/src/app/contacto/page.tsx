    ...
    <>
      ...
      <section style={{
        ...
        {[600,440,300,180].map(s => (
          <div key={s} style={{ position:'absolute', top:'50%', left:'50%', width:s, height:s,
        ...
        <div style={{ position:'absolute', bottom:'5%', right:'8%', width:300, height:300,
          borderRadius:'50%', background:'radial-gradient(circle,rgba(37,99,235,0.12),transparent 70%)',
          filter:'blur(40px)', pointerEvents:'none' }}/>

        <div className="container" style={{ position:'relative', zIndex:10 }}>
          <nav style={{ color:'rgba(255,255,255,.35)', fontSize:'0.75rem', marginBottom:20,
          ...
          <span style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'0.38rem 1.2rem',
          ...
          <h1 style={{ fontFamily:'var(--font-playfair)', color:'#fff',
      ...
      <section style={{
        ...
        <div style={{ position:'absolute', bottom:'20%', left:'2%', width:350, height:350,
        ...
        <div className="container" style={{ position:'relative', zIndex:2 }}>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1.7fr', gap:'3.5rem', alignItems:'start' }}
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
              ...
              <div>
                ...
                <div style={{ display:'flex', gap:8 }}>
                  {[
                    { label:'IG', bg:'linear-gradient(135deg,#833ab4,#fd1d1d,#fcb045)', href: contacto.instagram||'https://www.instagram.com/jmdecoracionesyeventos1/' },
                    { label:'FB', bg:'#1877f2', href: contacto.facebook||'https://www.facebook.com/JM.EventosyDecoraciones' },
                    { label:'TT', bg:'#000',    href: contacto.tiktok||'https://www.tiktok.com/@jmdecoraciones.18' },
                  ].map(({ label, bg, href }) => (
                    <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                       style={{ width:42, height:42, borderRadius:11, background:bg,
            ...
            <div style={{ borderRadius:24, overflow:'hidden',
              ...
              {/* Card top strip */}
              <div style={{ padding:'1.75rem 2.25rem', borderBottom:'1px solid rgba(255,255,255,0.06)',
                background:'rgba(212,160,23,0.04)',
                display:'flex', alignItems:'center', justifyContent:'space-between', gap:12 }}>
                <div>
                  <h2 style={{ fontFamily:'var(--font-playfair)', color:'#fff', fontSize:'1.2rem',
              ...
              <div style={{ padding:'2.25rem' }}>
                {status === 'success' ? (
                  <div style={{ textAlign:'center', padding:'3.5rem 1rem' }}>
                    ...
                    <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
                      <a href={`https://wa.me/${wa}?text=Hola%2C%20acabo%20de%20enviar%20mi%20consulta!`}
                         target="_blank" rel="noopener noreferrer"
                         style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'0.8rem 1.5rem',
                           background:'#25d366', color:'#fff', borderRadius:10, fontWeight:700,
                           fontSize:'0.88rem', textDecoration:'none' }}>
                        {WA_SVG} WhatsApp
                      </a>
                      <button onClick={() => setStatus('idle')}
                              style={{ padding:'0.8rem 1.5rem', borderRadius:10,
                  ...
                  <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:14 }} noValidate>
                    ...
                    {error && (
                      <div style={{ background:'rgba(159,18,57,0.15)', border:'1px solid rgba(252,165,165,0.25)',
                    ...
                    <button type="submit" disabled={status === 'loading'}
                            style={{ padding:'1.1rem', border:'none', borderRadius:12,
                      ...
                      {status === 'loading'
                        ? <><span style={{ width:18, height:18, border:'2px solid rgba(10,22,40,.3)',
                            borderTopColor:'#0a1628', borderRadius:'50%',
                            animation:'cpSpin .7s linear infinite', display:'inline-block' }}/> Enviando…</>
                        : '✨ Enviar Consulta'}
                    </button>
                  </form>
                )}
