...
const DEFAULT_SECTIONS = [
  { title: '1. Responsable del Tratamiento', content: `J&M Eventos y Decoraciones, con sede en Sechura, Piura, Perú, es el responsable del tratamiento de los datos personales que nos proporciones a través de este sitio web, formularios de contacto o cualquier otro medio de comunicación.\n\nCorreo de contacto: jmdecoracionesyeventossechura@gmail.com\nTeléfono: (+51) 945 203 708` },
  ...
  { title: '11. Contacto', content: `J&M Eventos y Decoraciones\nSechura, Piura — Perú\n📧 jmdecoracionesyeventossechura@gmail.com\n📞 (+51) 945 203 708` },
];
...
export default function PrivacidadPage() {
  return (
    <LegalPageClient
      ...
      introText="En J&M Eventos y Decoraciones valoramos y respetamos tu privacidad. Esta política explica cómo recopilamos, usamos y protegemos la información personal que nos proporcionas."
