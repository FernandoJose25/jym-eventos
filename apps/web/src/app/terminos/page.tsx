...
const DEFAULT_SECTIONS = [
  ...
  { title: '8. Propiedad Intelectual', content: `Todo el contenido de este sitio web es propiedad de J&M Decoraciones y Eventos y está protegido por las leyes de propiedad intelectual vigentes en el Perú.` },
  { title: '9. Fotografía y Redes Sociales', content: `Las fotografías y videos del evento pueden ser utilizadas por J&M Decoraciones y Eventos con fines de portafolio y marketing, salvo que el cliente indique expresamente lo contrario por escrito antes del inicio del evento.` },
  { title: '10. Limitación de Responsabilidad', content: `En ningún caso J&M Decoraciones y Eventos será responsable de daños indirectos, incidentales, especiales o consecuentes. Nuestra responsabilidad total no excederá el importe pagado por el servicio en cuestión.` },
  ...
  { title: '13. Contacto', content: `J&M Decoraciones y Eventos\nSechura, Piura — Perú\n📧 jmdecoracionesyeventossechura@gmail.com\n📞 (+51) 945 203 708` },
];
...
export default function TerminosPage() {
  return (
    <LegalPageClient
      ...
      introText="Por favor, lee atentamente estos Términos del Servicio antes de contratar cualquier servicio de J&M Decoraciones y Eventos. Al hacerlo, aceptas los términos y condiciones descritos a continuación."
